...
void PhysarumSynth::setup(int numVoices){
...
void PhysarumSynth::Voice::setup( PhysarumSynth & m, int v ){
...
float PhysarumSynth::Voice::meter_mod_env() const{
    return envelope.meter_output();
}

float PhysarumSynth::Voice::meter_pitch() const{
    return oscillator.meter_pitch();
}

pdsp::Patchable& PhysarumSynth::ch( int index ){
    index = index%2;
